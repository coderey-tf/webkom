...
@section('content')
    ...
    <main class="container mx-auto min-h-screen py-12 px-4 md:px-10">
        <div class="w-full flex flex-col md:flex-row justify-between md:items-center mb-8">
            ...
            <a href="{{ route('post.index') }}" class="flex items-center text-gray-800 hover:text-gray-500">
        ...
        @foreach ($posts as $post)
            <div class="shadow-md flex flex-wrap w-full md:h-64 mb-10 rounded-md overflow-hidden">
                @if ($post->sampul)
                    <div class="bg-cover bg-bottom border w-full md:w-2/5 h-44 md:h-full relative"
                        ...
                        <div
                            ...
                            <div class="w-full text-center md:text-left">
                                <a href="{{ route('post.show', $post) }}" class="block">
                                    <h3 class="text-lg font-bold capitalize hover:text-blue-500 hover:underline">
                                        {{ $post->judul }}</h3>
                                </a>
        ...
        <div class="w-full h-[70vh] rounded-md overflow-hidden shadow-md p-2 bg-white">
            <iframe
